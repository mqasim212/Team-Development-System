...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnDisplayAll" runat="server" style="z-index: 1; left: 257px; top: 478px; position: absolute; height: 40px; width: 157px" Text="Display All" OnClick="btnDisplayAll_Click" />
