...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 94px; top: 535px; position: absolute; height: 42px; width: 90px" Text="Add" />
        ...
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 370px; top: 533px; position: absolute; height: 45px; width: 101px" Text="Delete" />
    </form>
</body>
</html>
