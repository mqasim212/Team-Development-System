...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" style="z-index: 1; left: 108px; top: 40px; position: absolute; width: 271px" Text="Full Name | Email Address"></asp:Label>
    </form>
</body>
</html>
