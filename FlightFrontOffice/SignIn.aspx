...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="True" style="z-index: 1; left: 316px; top: 44px; position: absolute; height: 48px; width: 374px; margin-right: 60px;" Text="Account Sign In Page"></asp:Label>
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 379px; top: 254px; position: absolute" Text="[lblError]" Font-Bold="True" Font-Size="Larger"></asp:Label>
        <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" style="z-index: 1; left: 469px; top: 332px; position: absolute; height: 52px; width: 129px" Text="Cancel" />
        <asp:Button ID="btnForgotPassword" runat="server" OnClick="btnForgotPassword_Click" style="z-index: 1; left: 623px; top: 331px; position: absolute; height: 51px; width: 140px; bottom: 394px;" Text="Forgot Password" />
