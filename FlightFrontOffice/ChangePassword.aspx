...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblError" runat="server" Font-Bold="True" Font-Size="Larger" style="z-index: 1; left: 810px; top: 213px; position: absolute" Text="[lblError]"></asp:Label>
        <asp:Button ID="btnConfirm" runat="server" OnClick="btnConfirm_Click" style="z-index: 1; left: 585px; top: 435px; position: absolute; height: 51px; width: 118px" Text="Confirm" />
        <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" style="z-index: 1; left: 442px; top: 433px; position: absolute; height: 53px; width: 115px" Text="Cancel" />
        <p>
