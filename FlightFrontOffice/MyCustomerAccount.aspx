...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnChangePassword" runat="server" style="z-index: 1; left: 906px; top: 339px; position: absolute; height: 67px; width: 202px" Text="Change Password" />
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" style="z-index: 1; left: 407px; top: 118px; position: absolute" Text="My Account (Customer)"></asp:Label>
