...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApply" runat="server" style="z-index: 1; left: 105px; top: 494px; position: absolute; height: 47px; width: 118px" Text="Apply" OnClick="btnApply_Click" />
        ...
        <p>
            <asp:Button ID="btnDisplayAll" runat="server" OnClick="btnDisplayAll_Click" style="z-index: 1; left: 275px; top: 493px; position: absolute; height: 47px; width: 160px" Text="Display All" />
        </p>
    </form>
</body>
</html>
